...
import type { LoginData, LoginError, LoginResponse, SignupData, SignupError, SignupResponse, FindUserByEmailData, FindUserByEmailError, FindUserByEmailResponse, GetPublicUserData, GetPublicUserError, GetPublicUserResponse, GetUserDetailData, GetUserDetailError, GetUserDetailResponse, DeleteUserData, DeleteUserError, DeleteUserResponse, CreateNewKeyData, CreateNewKeyError, CreateNewKeyResponse, ListSessionsData, ListSessionsError, ListSessionsResponse, CreateSessionData, CreateSessionError, CreateSessionResponse, GetSessionData, GetSessionError, GetSessionResponse, RenameSessionData, RenameSessionError, RenameSessionResponse, DeleteSessionData, DeleteSessionError, DeleteSessionResponse, ChatData, ChatError, ChatResponse, LambdaError, LambdaResponse } from './types.gen';
...
export class UserService {
     ...
     * Get Public User
     */
    public static getPublicUser<ThrowOnError extends boolean = false>(options?: Options<GetPublicUserData, ThrowOnError>) {
...
export class GptService {
     ...
     * List Sessions
     */
    public static listSessions<ThrowOnError extends boolean = false>(options?: Options<ListSessionsData, ThrowOnError>) {
