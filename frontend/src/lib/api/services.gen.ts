...
import type { AuthLoginData, AuthLoginError, AuthLoginResponse, AuthSignupUserData, AuthSignupUserError, AuthSignupUserResponse, UserUserDetailData, UserUserDetailError, UserUserDetailResponse, UserDeleteUserData, UserDeleteUserError, UserDeleteUserResponse, UserAddApiKeyData, UserAddApiKeyError, UserAddApiKeyResponse, UserFindUserByEmailData, UserFindUserByEmailError, UserFindUserByEmailResponse, GptListSessionsError, GptListSessionsResponse, GptCreateSessionError, GptCreateSessionResponse, GptGetSessionData, GptGetSessionError, GptGetSessionResponse, GptRenameSessionData, GptRenameSessionError, GptRenameSessionResponse, GptDeleteSessionData, GptDeleteSessionError, GptDeleteSessionResponse, GptChatData, GptChatError, GptChatResponse, HealthCheckLambdaError, HealthCheckLambdaResponse } from './types.gen';
...
export class UserService {
     ...
     * Private user info
     */
    public static userUserDetail<ThrowOnError extends boolean = false>(options: Options<UserUserDetailData, ThrowOnError>) {
        return (options?.client ?? client).get<UserUserDetailResponse, UserUserDetailError, ThrowOnError>({
            ...options,
