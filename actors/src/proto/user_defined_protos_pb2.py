...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_USERDEFINEDSERVICE']._serialized_end=633
  _globals['_IMAGECLASSIFICATIONSERVICE']._serialized_start=635
  _globals['_IMAGECLASSIFICATIONSERVICE']._serialized_end=735
