...
- follow open-close principle, if we want to change the third-party library,we can simply extend the wrap class 
- good for testing, we can always create a fake, in-memory version of the wrap class, like in-memory redis, in-memory database, etc.
